...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ExperimentalEnvelope.rho'
        db.alter_column(u'sur_experimentalenvelope', 'rho', self.gf('picklefield.fields.PickledObjectField')(null=True))

        # Changing field 'EosEnvelope.rho'
        db.alter_column(u'sur_eosenvelope', 'rho', self.gf('picklefield.fields.PickledObjectField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'ExperimentalEnvelope.rho'
        raise RuntimeError("Cannot reverse this migration. 'ExperimentalEnvelope.rho' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'ExperimentalEnvelope.rho'
        db.alter_column(u'sur_experimentalenvelope', 'rho', self.gf('picklefield.fields.PickledObjectField')())

        # User chose to not deal with backwards NULL issues for 'EosEnvelope.rho'
        raise RuntimeError("Cannot reverse this migration. 'EosEnvelope.rho' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'EosEnvelope.rho'
        db.alter_column(u'sur_eosenvelope', 'rho', self.gf('picklefield.fields.PickledObjectField')())
